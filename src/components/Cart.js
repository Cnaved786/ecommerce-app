    ...
    <div className="container">
            ...
            <div className="cart-details" style={{marginTop:'100px'}}>
             {shoppingCart.length>0 ?
                ...
                <div className="cart" key={cart.id}>
                    ...
                    <span classsName="cart-product-price">${cart.price}</span>
                    ...
                    <span className="delete-product" onClick={() => dispatch({type:'DELETE',id:cart.id,cart})}><i className ="fa-sharp fa-solid fa-trash"></i></span>
                </div>
               ))
      ...
      {shoppingCart.length >0 ? <div className="cart-summary">
         <div className="summary">
            ...
            <div classsName="items-count">{qty}</div>
            </div>
